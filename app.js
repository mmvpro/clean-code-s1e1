...
var incompleteTaskHolder=document.getElementById("incomplete-items");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    listItem.classList.add("todo__box__item")

    label.innerText=taskString;
    label.className='todo__box__item__label';
    ...
    deleteButtonImg.className="todo__box__item__img"
